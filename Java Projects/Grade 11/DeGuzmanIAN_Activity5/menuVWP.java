...
public class menuVWP extends processVWP
{
    public static void main(String args[]) throws IOException, InterruptedException
    {
        ins.methodType = "Void type With Parameters";
        ...
        while(!ins.menuchoice.equals("6"))
        {
            ...
            switch(ins.menuchoice.toLowerCase())
            {
                ...
                case "2": case "item 2":
                    ...
                    vwp.item2(workHours, workRate, deductions);
                ...
                case "3": case "item 3":
                    ...
                    System.out.print("Enter your final exams score: ");
                    finalExam = ins.scanInt();

                    vwp.item3(midterm, finalExam);
                ...
                case "4": case "item 4":
                    ...
                    vwp.item4(courseTitle, enrollees);
                ...
                case "5": case "item 5":
                    ...
                    vwp.item5(name, basicSalary, serviceTime);
